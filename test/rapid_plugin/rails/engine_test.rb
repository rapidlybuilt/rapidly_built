  ...
  module Rails
    class EngineTest < ActiveSupport::TestCase
      ...
      test "#plugin_application returns the default application" do
        ...
        default_app = RapidPlugin.config.default_application
      ...
      test "engine has isolated namespace" do
        ...
        # Verify the engine is in the RapidPlugin::Rails module
        assert_equal RapidPlugin::Rails, Engine.module_parent
      end
    end
  end
end
