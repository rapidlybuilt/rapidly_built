module RapidPlugin
  module Rails
    # Controller helper for integrating RapidPlugin with Rails controllers
    #
    # Provides access to the mounted RapidPlugin::Application instance and
    ...
    module ControllerHelper
      ...
      # Get the RapidPlugin::Application instance for the current request
      #
      ...
      # Find the RapidPlugin::Application instance using the app parameter
      #
      # @return [Application, nil] The application instance, or nil if not found
      def find_application(name = params[:app_id])
        RapidPlugin.config.application(name)
      end
